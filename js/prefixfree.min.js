 ...
 * Licencia MIT
 * /
(function () {function m (a, b) {return []. slice.call ((b || document) .querySelectorAll (a))} if (window.addEventListener) {var e = window.StyleFix = {link : función (a) {var b = a.href || a.getAttribute ("data-href"); intente {if (! b || "stylesheet"! == a.rel || a.hasAttribute ("data -noprefix ")) return} catch (p) {return} var d = b.replace (/ [^ \ /] + $ /," "), f = (/ ^ [az] {3,10}: / .exec (d) || [""]) [0], h = (/ ^ [az] {3,10}: \ / \ / [^ \ /] + /. exec (d) || [" "]) [0], k = / ^ ([^?] *) \ ?? /. Exec (b) [1], g = a.parentNode, c = new XMLHttpRequest, l; c.onreadystatechange = function ( ) {4 === c.readyState &&
...
a.disabled; a.textContent = e.fix (a.textContent,! 0, a); a.disabled = b}}, styleAttribute: function (a) {var b = a.getAttribute ("style"), b = e.fix (b,! 1, a); a.setAttribute ("estilo", b)}, proceso: función () {m ('link [rel = "stylesheet"]: no ([data-inprogress] ) '). forEach (StyleFix.link); m ("estilo"). forEach (StyleFix.styleElement); m ("[estilo]"). forEach (StyleFix.styleAttribute)}, registro: función (a, b) {(e.fixers = e.fixers || []). splice (void 0 === b? e.fixers.length: b, 0, a)}, fix: function (a, b, d) {if (e.fixers) para (var f = 0; f <e.fixers.length; f ++) a =
...
(función (m) {función e (b, d, f, h, k) {b = a [b]; b.length && (b = RegExp (d + "(" + b.join ("|") + " ) "+ f," gi "), k = k.replace (b, h)); devuelve k} if (window.StyleFix && window.getComputedStyle) {var a = window.PrefixFree = {prefixCSS: function (b, d, f) {var h = a.prefix; -1 <a.functions.indexOf ("linear-gradient") && (b = b.replace (/ (\ s |: |,) (repitiendo -)? linear-gradient \ (\ s * (-? \ d * \.? \ d *) deg / ig, función (b, a, d, f) {return a + (d || "") + "linear-gradient (" + (90-f) + "deg"})); b = e ("funciones", "(\\ s |: |,)", "\\ s * \\ (", "$ 1" + h + "$ 2 (", b); b = e (" palabras clave "," (\\ s | :) "," (\\ s |; | \\} | $) ",
